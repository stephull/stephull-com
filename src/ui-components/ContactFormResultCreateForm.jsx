...
export default function ContactFormResultCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setSuccess(initialValues.success);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ContactFormResult(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ContactFormResultCreateForm")}
      {...rest}
    >
      <SwitchField
        label="Success"
